...
@Component({
  selector: 'bank-account-status-filter',
  templateUrl: './bank-account-status-filter.html',
  styleUrl: './bank-account-status-filter.scss',
  imports: [NgSelectModule, FormsModule, TranslateModule, CommonModule]
})

export class BankAccountStatusFilter {
