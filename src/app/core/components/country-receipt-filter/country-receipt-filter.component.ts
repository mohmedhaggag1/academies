...
@Component({
  selector: 'country-receipt-filter',
  templateUrl: './country-receipt-filter.component.html',
  styleUrls: ['./country-receipt-filter.component.scss'],
  imports: [NgSelectModule, FormsModule, TranslateModule, CommonModule]
})

export class CountryReceiptFilterComponent {
